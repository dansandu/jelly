...
inline auto sliceWhitespace(std::string_view string)
{
    return sliceWhitespaceAt(string.cbegin(), string);
}

inline auto sliceNumber(std::string_view string)
{
    return sliceNumberAt(string.cbegin(), string);
}

inline auto sliceString(std::string_view string)
{
    return sliceStringAt(string.cbegin(), string);
}
...
template<std::optional<dansandu::glyph::token::Token> (*... slicers)(std::string_view::const_iterator,
                                                                     std::string_view)>
auto fallbackSliceAt([[maybe_unused]] std::string_view::const_iterator begin, [[maybe_unused]] std::string_view string)
{
    using dansandu::glyph::token::Token;
