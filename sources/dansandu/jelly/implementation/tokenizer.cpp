...
std::vector<Token> tokenize(std::string_view string) {
    ...
    auto slicer = fallbackSliceAt<sliceAtUsing<ArrayBeginSliceTraits>, sliceAtUsing<ArrayEndSliceTraits>,
                                  sliceAtUsing<BooleanSliceTraits>, sliceAtUsing<ColonSliceTraits>,
                                  sliceAtUsing<CommaSliceTraits>, sliceAtUsing<NullSliceTraits>,
                                  sliceAtUsing<ObjectBeginSliceTraits>, sliceAtUsing<ObjectEndSliceTraits>,
                                  sliceNumberAt, sliceStringAt, sliceWhitespaceAt>;
